...
<p align="center">
  <img src="assets/workpass-app-overview-portrait.png" alt="WorkPass Connect app overview — one trusted app for your work pass needs" width="600">
</p>
...
| Value | Impact |
|---|---|
| Increased Adoption | Clear and relevant value motivates Work Pass Holders to download and use the app |
| Stronger Engagement | Regular task-driven interactions create reasons for users to return |
| Better Compliance | Timely completion of required actions supports regulatory compliance |
| Reduced Support Load | Proactive reminders and self-service reduce enquiries and walk-ins |
| Higher Trust & Satisfaction | Easy access to the work pass builds confidence in MOM services |

**Official & Trusted · Secure & Private · Timely Notifications · All in One Place**

> Better for users. Better for MOM.

## Assets

| File | Description |
|---|---|
| [`assets/workpass-app-overview-portrait.png`](assets/workpass-app-overview-portrait.png) | Portrait overview of the app and its two core values |
| [`assets/workpass-value-proposition-v2.png`](assets/workpass-value-proposition-v2.png) | Landscape value-proposition infographic with stakeholder benefits |
